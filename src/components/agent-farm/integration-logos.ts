...
export const DOCUMENTED_ENV_LOGOS: Record<string, string> = {
  ...
  HARMONY_CLIENT_PROJECTS_AI_KEY: ENV_KEY_LOGO_URL.GEMINI_API_KEY,
  FFMPEG_PATH: 'https://upload.wikimedia.org/wikipedia/commons/5/5f/FFmpeg_Logo_new.svg',
  YT_DLP_PATH: 'https://cdn-icons-png.flaticon.com/512/1384/1384060.png',
  VITE_GOOGLE_MAPS_EMBED_API_KEY: ENV_KEY_LOGO_URL.GOOGLE_API_KEY,
  VITE_STEM_SERVICE_URL: 'https://vitejs.dev/logo.svg',
  VITE_LOCAL_LLM_BASE_URL: 'https://vitejs.dev/logo.svg',
  VITE_LOCAL_LLM_MODEL: 'https://vitejs.dev/logo.svg',
  VITE_RAG_MANIFEST_URL: 'https://vitejs.dev/logo.svg',
